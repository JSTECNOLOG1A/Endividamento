...
const PAYABLE_SORT_COLUMNS = {
  erpStatus: { getValue: (row) => erpStatusOf(row) },
  entity_name: {},
  filial: {},
  filial_origem: {},
  fornecedor: { getValue: (row) => supplierLabel(row) },
  prefixo: {},
  titulo_numero: {},
...
export default function AccountsPayable() {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 py-8" data-tour="payables-workspace">
            ...
            <table className="w-full min-w-[1580px] caption-bottom text-[11px]">
              <thead>
                <tr className="border-b bg-slate-50">
                  ...
                  <SortableTh sortField="fornecedor" sortKey={sortKey} sortDir={sortDir} onSort={toggleSort}>Fornecedor</SortableTh>
