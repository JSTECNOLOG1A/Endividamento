...
export default function Simulator() {
  ...
  const loadContractForEdit = React.useCallback(async (contractId, { duplicate = false } = {}) => {
    try {
      ...
      const contractFormData = {
        ...
        creditor_cnpj: contract.creditor_cnpj || "",
        ...
        transaction_cost_recognition: contract.transaction_cost_recognition || "imediato",
  ...
  const persistContract = async (targetStatus) => {
    ...
    const contractData = {
      ...
      creditor_cnpj: formParams.creditor_cnpj ? String(formParams.creditor_cnpj).replace(/\D/g, "") || null : null,
      ...
      transaction_cost_recognition: formParams.transaction_cost_recognition === "amortizado" ? "amortizado" : "imediato",
  ...
  const handleCloseContract = async () => {
    ...
    try {
      const closeContractData = {
        ...
        creditor_cnpj: dataToSave.creditor_cnpj ? String(dataToSave.creditor_cnpj).replace(/\D/g, "") || null : null,
        ...
        transaction_cost_recognition: dataToSave.transaction_cost_recognition === "amortizado" ? "amortizado" : "imediato",
