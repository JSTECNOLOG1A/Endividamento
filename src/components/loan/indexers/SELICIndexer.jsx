import { IndexerStrategy } from "./IndexerStrategy";

/**
 * SELIC Indexer - Capitalização exponencial (base 252 DU)
 * Praticamente idêntica ao CDI, mas com dados de SELIC
 */
export class SELICIndexer extends IndexerStrategy {
