...
export const PARAMETER_DEFINITIONS = [
  ...
  {
    key: "accounting.main_title_account",
    category: "accounting",
    type: "STRING",
    label: "Conta contábil do título principal",
    description: "Código da conta contábil (plano de contas) aplicada aos títulos de amortização/principal. Ex.: 2110101001. Deixe vazio para informar depois.",
    defaultValue: "",
    isEditable: true,
    implemented: true,
    writableScopes: ["TENANT"],
  ...
  {
    key: "accounting.interest_title_account",
    category: "accounting",
    type: "STRING",
    label: "Conta contábil do título de juros",
    description: "Código da conta contábil aplicada aos títulos de juros e IOF. Ex.: 3110101001. Deixe vazio para informar depois.",
    defaultValue: "",
    isEditable: true,
    implemented: true,
    writableScopes: ["TENANT"],
