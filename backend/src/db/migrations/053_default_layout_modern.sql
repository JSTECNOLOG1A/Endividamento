-- 053: layout Modern como padrão da plataforma (Classic permanece opcional por tenant)
...
SELECT 'GLOBAL', NULL, NULL, 'appearance.default_layout', '{"v":"modern"}'::jsonb, 'migration_053'
WHERE NOT EXISTS (
...
WHERE scope = 'TENANT'
  ...
  AND updated_by IN ('migration_049', 'migration_053');
